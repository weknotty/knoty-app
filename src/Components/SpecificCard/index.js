...
const SpecificCard = () => {
  ...
  return (
    <div className="animated col-xxl-5 col-xl-5 col-lg-6 col-md-6 col-sm-12 col-11 d-flex flex-column justify-content-start align-items-center CardContainer ">
