...
const SpecificCard = () => {
  ...
  useEffect(() => {
    if (swipedRight) {
      ...
      setCardLiked(userID, interactedCards, currentCard)
  ...
  return (
    <div
      className="animated col-xxl-5 col-xl-5 col-lg-6 col-md-6 col-sm-11 col-11 d-flex flex-column justify-content-center align-items-center profileContainer position-relative"
      
    >
      <div className="col-12 d-flex flex-row justify-content-center align-items-center" ref={ref} id="containerus" {...swipeHanlder}>
